<template>
  <div class="app_container">
    <div class="head_nv">
      ...
      <div class="nav">
        <ul>
          <li><a href="#" @click="gotoHomePage">平台首页</a></li>
          <li><a href="./homePage.vue#product">系列产品</a></li>
          <li style="border-bottom:2px solid #26a9de"><a href="#" @click="gotoNewspage">最新动态</a></li>
